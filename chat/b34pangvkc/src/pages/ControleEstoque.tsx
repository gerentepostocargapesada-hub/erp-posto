        ...
        reader.onload = (ev) => {
          ...
          if (fn.includes("bico")) {
            ...
            const parsed: PerdasSobrasLMC[] = rows
              .map((r) => ({
                produto: (r["prl_ds_produto_lmc"] || "").trim(),
                perdasSobras: parseBR(r["lmc_vl_perda_sobra"]),
                impacto: 0,
              }))
              .filter((p) => p.produto);
    ...
    <div className="p-6 max-w-[1600px] mx-auto flex flex-col gap-5">
      ...
      <div className="flex items-start justify-between pb-4 border-b border-[#262a31]">
        ...
        <div className="flex items-center gap-3">
          {/* Period */}
          <div className="flex items-center gap-2 bg-[#1d2027] border border-[#262a31] rounded-md px-3 py-2">
            ...
            <input
              ...
              className="bg-transparent border-none text-[12px] text-white font-['JetBrains_Mono',monospace] focus:outline-none"
            />
            <span className="text-[10px] text-[#6b7280]">até</span>
            <input
              type="date"
              value={periodoFim}
                            ...
                            >
                              ...
                              <td className="px-2 py-1.5">
                                <input
                                  ...
                                  className="w-20 bg-[#1d2027] border border-[#262a31] rounded px-2 py-1 text-[11px] text-white font-['JetBrains_Mono',monospace] focus:border-[#00a572] focus:outline-none transition-colors text-center"
                                />
                              </td>
        ...
        {perdasSobras.length === 0 ? (
          ...
          <div>
            ...
            <div className="flex items-center justify-end gap-6 pt-3 mt-2 border-t border-[#262a31]">
              ...
              <div className="flex items-center gap-2">
                <span className="text-[13px] font-bold font-['JetBrains_Mono',monospace] text-[#f87171]">
